...
@export var sight: int = 100             # Tầm nhìn của enemy
@export var spike: int = 0               # Sát thương khi player chạm phải
@export var movement_range: int = 200    # Khoảng cách enemy được phép di chuyển
